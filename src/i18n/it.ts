const it = {
  ...
  'choose.feature1.desc': 'Abbiamo successo solo quando lo hai anche tu. Paghi soltanto se riduciamo i costi (tratteniamo il 40% dei risparmi).',
  ...
  'how.step4.desc': 'Finalizziamo l\'accordo migliorato e quantifichiamo i risparmi. Tu mantieni il 60% dei guadagni e ci paghi il restante 40%. Se non si ottengono risparmi, non ci devi nulla.',
  ...
  'services.remember': '💡 Ricorda: ci paghi solo il 40% dei risparmi verificati. Nessun risparmio = nessun costo.',
  ...
  'faq.a1': 'Significa che non paghi mai costi iniziali. Ci facciamo pagare solo il 40% dei soldi che effettivamente ti facciamo risparmiare. Se non otteniamo risparmi, non ci devi nulla.',
  ...
  'faq.a4': 'Confrontiamo costi o termini prima e dopo la nostra negoziazione. La tua quota di risparmio è il 60% del miglioramento ottenuto; il restante 40% è il nostro compenso.',
  ...
  'contact.ourPromiseText': 'Ricorda, la consulenza è completamente gratuita e senza impegno. Ti addebiteremo solo il 40% dei risparmi verificati.',
